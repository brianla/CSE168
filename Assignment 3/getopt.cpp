...
{
	return _getopt_internal(argc, argv, shortopts, (const struct option *) 0, (int *) 0, 0);
}

int getopt_long(int argc, char *const *argv, const char *shortopts, const struct option* long_options, int *opt_index)
{
	return _getopt_internal(argc, argv, shortopts, long_options, opt_index, 0);
}
